...
const BenefitsSection: React.FC = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-white to-yellow-50 py-16 px-4">
      <div className="container mx-auto">
        <div className="text-center mb-10">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Vantagens de ser um Motorista Parceiro Mercado Livre</h2>
          <div className="w-20 h-1 bg-mercadolivre-secondary mx-auto rounded-full"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {benefits.map((benefit, index) => (
            <div key={index} className="bg-white p-6 rounded-lg shadow-lg transition-transform duration-300 hover:transform hover:-translate-y-2 border-t-4 border-mercadolivre-secondary">
              <div className="text-mercadolivre-secondary text-4xl mb-4 flex justify-center">
        ...
        <div className="text-center mt-12 rounded-lg p-8 text-white shadow-lg" style={{ backgroundColor: '#303674' }}>
          <h3 className="text-xl font-bold mb-4">Você está no controle. Você define seus ganhos.</h3>
          <p className="max-w-3xl mx-auto">No Mercado Livre, acreditamos que você merece flexibilidade e recompensas justas pelo seu trabalho. Nossa plataforma foi projetada para valorizar cada entrega que você faz, garantindo os melhores ganhos do mercado.</p>
        </div>
      </div>
    </section>
  );
