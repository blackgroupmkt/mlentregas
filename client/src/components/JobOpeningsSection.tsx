      ...
      <div className="max-w-6xl mx-auto">
        ...
        {isLoading ? (
          <div className="text-center py-10">
            <div className="inline-block h-8 w-8 animate-spin rounded-full border-4 border-solid border-[#303674] border-r-transparent"></div>
                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className={`px-3 py-1 rounded-[3px] ${hasVacancies ? 'bg-[#FFE602] bg-opacity-50' : 'bg-gray-200'}`}>
                        <span className={`text-sm sm:text-base font-semibold ${hasVacancies ? 'text-[#303674]' : 'text-gray-500'}`}>
                          {hasVacancies ? (
                            <>
                    ...
                    <button 
                      className={`w-full ${
                        hasVacancies 
                          ? 'bg-[#303674] hover:bg-[#242960] text-white' 
