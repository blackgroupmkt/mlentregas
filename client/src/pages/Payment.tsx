      ...
      <div className="w-full bg-[#FFE602] py-1 px-6 flex items-center relative overflow-hidden">
        ...
        <div className="flex items-center relative z-10">
          ...
          <div className="leading-none">
            <h1 className="text-base font-bold text-[#303674] mb-0">Pagamento Personalizado</h1>
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="bg-white shadow-md rounded-lg overflow-hidden mb-8">
            <div className="bg-[#F8F8FF] p-4 border-b border-[#272F7620]">
              <h3 className="font-semibold text-[#272F76] text-center">Pagamento do Kit de Segurança</h3>
            </div>
            ...
            <div className="p-4">
              {isLoading ? (
                ...
                <div className="py-8 text-center">
                  ...
                  <Button
                    onClick={() => setLocation('/')}
                    className="bg-[#272F76] hover:bg-[#1e234d]"
                  >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-row gap-3 items-start">
                    ...
                    <div className="flex-grow">
                      ...
                      <p className="text-lg font-bold text-[#272F76]">R$ 64,90</p>
                  ...
                  {paymentInfo?.status === 'APPROVED' ? (
                    ...
                    <div className="flex items-center justify-center gap-2 py-2 bg-[#f8f8ff] rounded-md">
                      <div className="text-[#272F76] animate-spin">
                  ...
                  {paymentInfo?.status === 'REJECTED' && (
                    <div className="flex flex-col items-center justify-center p-6 bg-[#fff8f8] rounded-md border border-red-100 mt-4">
                      ...
                      <Button
                        onClick={() => setLocation('/')}
                        className="bg-[#272F76] hover:bg-[#1e234d] text-white"
                      >
